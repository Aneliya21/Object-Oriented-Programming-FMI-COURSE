...
//    }
//
//    bool compareDurations(const Time& first, const Time& second) const {       //if first is less return true
...
int main() {
    Playlist pl;
    pl.addToPlaylist("Song3", 0, 5, 34, "rp", "song1.txt");
    pl.addToPlaylist("Song1", 0, 4, 0, "he", "song2.txt");
    pl.addToPlaylist("Song2", 0, 2, 34, "r", "song3.txt");
